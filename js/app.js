    ...
    t = {
        ...
        80: (e, t, r) => {
            ...
            function c(e) {
                if (s(e) && (
                    ...
                    n = r[1] + "." + r[0],
                    document.cookie = t + "=; domain=" + n + "; Path=/; Expires=Thu, 01 Jan 1970 00" +
                            ":00:01 GMT;",
                    !s(e)
                )) {
                    try {
            ...
            var u = document
                    .getElementById("app-url")
                    .value,
                l = document
                    .getElementById("is-featured")
                    .value,
            ...
            function m() {
                ...
                if ("" != t) {
                    ...
                    document
                        ...
                        .toggle("op-0"),
                    document
                        .getElementById("subsc-email-error")
                        .innerText = "",
                    document
                    ...
                    i.onreadystatechange = function () {
                        if (4 === i.readyState && 200 === i.status) {
                            ...
                            var e = document
                                ...
                                .value;
                            document
                                .getElementById("thank_you_msg")
                                .innerHTML = "You’re subscribed as " + e,
                            document
                                .getElementById("subsc-email")
                                .value = "";
                            for (
                                var t = document.getElementsByClassName("hide-after-success"),
                                r = 0;
                                r < t.length;
                                r++
                            ) 
                            ...
                            setTimeout((function () {
                                ...
                                document
                                    .getElementById("featured-subscribers")
                                    .classList
                                    .toggle("hide-subscribers")
                            }), 3e3)
                        } else 
                            "" != i.responseText && JSON
                                .parse(i.responseText)
                                .errors && p(JSON.parse(i.responseText).errors.email[0]),
                            f = !1
                    },
                    i.open(
                        "post",
            ...
            window.onload = function () {
                ...
                var e,
                    t = document
                        .getElementById("page-type")
                        .value;
                null == h && "true" == l && (
                    "creator-page" == t && (
                        document.getElementById("toggle-subscription-btn").addEventListener("click", (function (e) {
                            document
                                .getElementById("featured-subscribers")
                                .classList
                                .toggle("hide-subscribers"),
                        ...
                        "true" === l && document.querySelector("#featured-subscribers") && document.querySelector("#featured-subscribers").addEventListener("click", (function (e) {
                            document
                                .getElementById("featured-subscribers")
                                .classList
                                .contains("hide-subscribers") && "toggle-subscription-btn" !== e
                                .target
                                .id && "sub-toggle" !== e
                                .target
                                .id
                                    ? (
                                        ...
                                        f && document.getElementsByClassName("thank-you-title")[0].classList.toggle(
                                            "hidden"
                                        ),
        ...
        666: e => {
            var t = function (e) {
                ...
                function u(e, t, r, n) {
                    var o = t && t.prototype instanceof p
                            ? t
                            : p,
                ...
                return y.prototype = L.constructor = v,
                v.constructor = y,
                ...
                _.prototype = {
                    ...
                    abrupt: function (e, t) {
                        ...
                        a && ("break" === e || "continue" === e) && a.tryLoc <= t && t <= a.finallyLoc && (
                            a = null
                        );
                        var i = a
                            ? a.completion
